...
import static daredevil.webcam.DetectionObjet.Mat2bufferedImage;
            ...
            while (true) {
                ...
                if (!frame.empty()) {
                    ...
                    if (data2.length > 0) {
                        ...
                        Imgproc.putText(frame, "( x = " + data2[0] + ", y = " + data2[1] + " )", new Point(data2[0], data2[1]), 1, 1, new Scalar(0, 255, 0));
                        posX = (int) data2[0];
                        posY = (int) data2[1];
                    }
